...
function [LF, LFWeight, DecodeOptions, DebayerLensletImage, CorrectedLensletImage, LFsliced, LFuvPixels, DevignetteImage, DevignetteImage2] = ...
    LFDecodeLensletImageSimple( LensletImage, WhiteImage, LensletGridModel, DecodeOptions )
